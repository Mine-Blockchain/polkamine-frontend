...
const MESSAGES = Object.freeze({
  ...
  CONNECT_ACCESS_BINANCE_ERROR: 'Please authorize this website to access your account.',
  CONNECT_UNKNOWN_ERROR: 'An unknown error occurred. Check the console for more details.',
  METAMASK_NOT_CONNECTED: 'Please connect Metamask and switch to Ethereum Chain.'
});
